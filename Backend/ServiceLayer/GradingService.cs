...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        public string DeleteBoard(string email, string name)
        {
            ...
            return factory.RemoveBoard(email, name);
        }
        ...
        {
            return factory.GetUserBoards(email);
        }
        ...
        {
            return factory.JoinBoard(email, boardID);
        }
        ...
        {
            return factory.LeaveBoard(email, boardID);
        }
        ...
        {
            return factory.AssignTask(email, boardName, columnOrdinal, taskID, emailAssignee);
        }
